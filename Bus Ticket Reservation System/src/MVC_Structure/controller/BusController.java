...
public class BusController implements Initializable {
    ...
    public void logout(ActionEvent actionEvent) {
        ...
        Parent parent = null;
        try {
            parent = FXMLLoader.load(getClass().getResource("/MVC_Structure/view/sample.fxml"));
    ...
    public void proceed(ActionEvent actionEvent) {
        ...
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/MVC_Structure/view/payment.fxml"));
            Scene scene = new Scene(parent);
            Stage window = (Stage)((Node) actionEvent.getSource()).getScene().getWindow();
            window.setScene(scene);
            window.show();
